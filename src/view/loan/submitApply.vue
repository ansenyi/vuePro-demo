...
export default {
    ...
    methods: {
        goApply() {
            if (this.data.selectWay === this.defaultSelect)
                this.$dialog("请选择还款方式");
            else if (this.data.selectAmount === this.defaultSelect)
                this.$dialog("请选择借款金额");
            else if (this.data.selectLimit === this.defaultSelect)
                this.$dialog("请选择借款期限");
            else if (this.$store.state["tempDesCont"] === "")
                this.$dialog("请填写描述内容");
            else if (this.data.selectTime === this.defaultSelect)
                this.$dialog("请选择时间段");
